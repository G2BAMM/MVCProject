...
namespace MVCWebProject2.DAL
{
    public class VehicleCategoriesDAL
    {
        ...
        {
            CreateConnection();
            SqlCommand cmd = new SqlCommand("GetVehicleCategoryList", conn);
        ...
        */
        ...
        {
            CreateConnection();
            SqlCommand cmd = new SqlCommand("GetVehicleCategoryDataSet", conn);
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    
        {
            CreateConnection();
            var returnValue = 0;
            SqlCommand cmd = new SqlCommand("UpdateVehicleCategory", conn);
            cmd.CommandType = CommandType.StoredProcedure;
